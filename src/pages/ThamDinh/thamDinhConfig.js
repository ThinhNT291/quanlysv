...
export const DICT_HO_SO = {
    ...
    tien_quyet: {
        ...
        // XetTuyenPage.jsx PHẢI đổi tên cùng lúc, vì cùng phải khớp tên cột thật trên
        // Goc01): "Bản sao Bằng Trung cấp"/"Bảng điểm Trung cấp" -> thêm hậu tố "(sau
        // 2022)" để phân biệt rõ với bộ hồ sơ "trước 2022" (vốn đã có tên riêng).
        "Tốt nghiệp Trung cấp sau 2022": [ { id: "doc_phieu_dk", name: "Phiếu đăng ký dự tuyển" }, { id: "doc_bang_tc", name: "Bản sao bằng trung cấp (sau 2022)" }, { id: "doc_diem_tc", name: "Bảng điểm trung cấp (sau 2022)" }, { id: "doc_ktvh_thpt", name: "Bằng THPT/GCN đủ KL KTVH THPT" } ],
